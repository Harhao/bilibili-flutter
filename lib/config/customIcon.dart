...
class CustomIcon {
  static const IconData settting =
      const IconData(0xe61a, fontFamily: 'custom', matchTextDirection: true);
  static const IconData shopCart =
      const IconData(0xe61c, fontFamily: 'custom', matchTextDirection: true);
  static const IconData home =
      const IconData(0xe617, fontFamily: 'custom', matchTextDirection: true);
  static const IconData channel =
      const IconData(0xe756, fontFamily: 'custom', matchTextDirection: true);
  static const IconData dynamicState =
      const IconData(0xe62d, fontFamily: 'custom', matchTextDirection: true);
  static const IconData email =
      const IconData(0xe670, fontFamily: 'custom', matchTextDirection: true);
